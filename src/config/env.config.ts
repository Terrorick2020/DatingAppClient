...
export const CHATS_METADATA_ENDPOINT = (chatId: string) => `${CHATS_ENDPOINT}/${chatId}${CHATS_METADATA}`;
export const CHATS_MSG_ENDPOINT      = (chatId: string) => `${CHATS_ENDPOINT}/${chatId}${CHATS_MSG}`;
export const CHATS_DEL_ENDPOINT      = (chatId: string) => `${CHATS_ENDPOINT}/${chatId}`;
